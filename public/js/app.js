...
topics = {
  human: {
    subjects: ["The worker", "The woman", "The man", " The robot", "The teacher", "A person", "The student", "The girl", "The baby", "The fireman", "A saleman", "A saler", "A manager", "My sister", "The professor", "The chef", "The waiter", "The actor", "The actress", "The developer", "The customer", "The client"],
    verbs: ["is doing", "is cooking", "is eating", "is playing", "is singing", "is reading", "is writing", "is buying", "is showing", "is checking", "is making", "is destroying", "is learning", "is collecting", "is baking", "is serving", "is planing", "is hitting"],
    directObjects: ["homeworks", "flowers", "laundry", "books", "Math", "goods", "an app", "cakes", "stamps", "houses", "Physic", "Web developtment", "Javascript", "piano", "an instrument", "football", "hockey", "foods", "the table"]
  },
  animals: {
    ...
    verbs: ["is hunting", "is chasing after", "is eating", "is climbing", "is barking at", "is doing", "is cooking", "is eating", "is playing", "is singing", "is reading", "is writing", "is buying", "is showing", "is checking", "is making", "is destroying", "is learning", "is collecting", "is baking", "is serving", "is planing", "is hitting"],
    directObjects: ["homeworks", "flowers", "laundry", "books", "Math", "goods", "an app", "cakes", "stamps", "houses", "Physic", "Web developtment", "Javascript", "piano", "an instrument", "football", "hockey", "foods", "the table"]
  }
};
...
function makeQuote(topic = topics.human) {
  ...
  len3 = topic.directObjects.length; // get random indexes
...
function getQuotes(topic, quantity) {
  /*
    ...
    */
  let quotesArr, output; // array that contains #number random quotesArr.
  ...
  output = ""; //loop through the array quotesArr.

  quotesArr.forEach((curr, index) => {
    output += "<p class='quote'>" + "<b>Quote #" + (index + 1) + ":</b> &nbsp;&nbsp;" + curr + "</p>" + "\n";
  });
  $(".board__display").html(output); // console.log(output);
}
